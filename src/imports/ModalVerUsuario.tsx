import svgPaths from "./svg-p0alf3d6sc";
import { imgVector, imgVector1 } from "./svg-8ci7x";
...
export default function ModalVerUsuario() {
  return (
    <div className="bg-[#22272a] relative rounded-[16px] size-full" data-name="Modal - ver usuario">
