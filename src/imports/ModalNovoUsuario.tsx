import svgPaths from "./svg-0aa0o3hpyk";
import { imgVector, imgVector1 } from "./svg-hxsxo";
...
export default function ModalNovoUsuario() {
  return (
    <div className="bg-[#22272a] relative rounded-[16px] size-full" data-name="Modal - Novo usuario">
