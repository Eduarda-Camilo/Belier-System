import svgPaths from "./svg-16znrqidat";
import { imgAlertBox } from "./svg-u4hym";

export default function AlertBox() {
  return (
    <div className="backdrop-blur-[45px] bg-[#22272a] content-stretch flex flex-col gap-[16px] items-start p-[24px] relative rounded-[12px] size-full" data-name="Alert Box">
