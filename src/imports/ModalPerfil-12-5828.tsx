import svgPaths from "./svg-05vmwn5a5y";
import { imgVector, imgVector1 } from "./svg-babmf";
...
export default function ModalPerfil() {
  return (
    <div className="bg-[#22272a] relative rounded-[16px] size-full" data-name="Modal - Perfil">
