import svgPaths from "./svg-bk16y7985e";
import { imgVector, imgVector1 } from "./svg-ufqia";
...
export default function ModalEditarUsuario() {
  return (
    <div className="bg-[#22272a] relative rounded-[16px] size-full" data-name="Modal - editar usuario">
