...
import ModalTrocarSenhaFigma from "../../imports/ModalPerfil-12-5828";
...
export function TrocarSenhaModal({ isOpen, onClose }: TrocarSenhaModalProps) {
