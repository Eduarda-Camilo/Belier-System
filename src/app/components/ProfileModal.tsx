...
import svgPaths from "../../imports/svg-5ej6ynx6at";
import { imgVector, imgVector1 } from "../../imports/svg-p8p9z";
...
export function ProfileModal({ isOpen, onClose }: ProfileModalProps) {
  const [name, setName] = useState("Fernanda Kempener");
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6" onClick={onClose}>
      ...
      <div
        ...
        data-name="Modal - Perfil"
      >
        {/* Header */}
        <div className="content-stretch flex gap-[24px] items-start mb-[24px] relative shrink-0 w-full">
          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
            ...
            <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f5f5f5] text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
              <p className="leading-[18px] whitespace-pre-wrap">Seu perfil ajuda as pessoas a reconhecerem você.</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        {/* Form Fields */}
        <div className="content-stretch flex flex-col gap-[16px] items-start mb-[24px] relative shrink-0 w-full">
          {/* Name */}
              ...
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex items-center p-[12px] relative w-full">
                  <input
                    ...
                    className="flex-[1_0_0] bg-transparent font-['Open_Sans:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px relative text-[#f5f5f5] text-[14px] text-left outline-none"
              ...
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative w-full">
                  <input
                    ...
                    className="flex-[1_0_0] bg-transparent font-['Open_Sans:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px relative text-[#f5f5f5] text-[16px] outline-none"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  />
                  <button
                    type="button"
        ...
        <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
          ...
          <button
            onClick={handleSave}
            className="bg-[#16a6df] hover:bg-[#1292c7] transition-colors flex-[1_0_0] h-[48px] min-h-px min-w-px relative rounded-[12px]" 
            data-name="Button"
          >
            <div className="flex flex-row items-center justify-center size-full">
              <div className="content-stretch flex items-center justify-center px-[24px] py-[12px] relative size-full">
